...
@Setter
@ToString
public class RestResult<T> implements Serializable, Result<T> {
    ...
    public static <T> RestResult<T> asError(Integer code, String msg, T content) {
        return asSuccessOrError(true, content, msg, code);
    }

    public static <T> RestResult<T> asError(Integer code) {
        return asError(code, null, null);
    }

    public static <T> RestResult<T> asError(Integer code, String msg) {
    ...
    public static final <T> RestResult<T> success() {
        return RestResult.asSuccess(null);
    }

    public static final RestResult<Object> SUCCESS_RESULT = RestResult.asSuccess(null);
    
    public static final <T> RestResult<T> fromOptional(Optional<T> optional, String msg) {
        return optional.map(RestResult::asSuccess).orElseGet(() -> RestResult.asError(404, msg));
    }
}
